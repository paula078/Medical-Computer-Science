...
class Inka:
    ...
    def butter_bandpass(lowcut, highcut, fs, order=5):
        ...
        nyq = 0.5 * fs
        b, a = butter(order, [lowcut/nyq, highcut/nyq], btype='bandpass', analog=False)
        return b, a
    ...
    def anim_process_frame(self, i):
        ...
        self.frame_median = np.median(frame_filtered[start_idx:end_idx], axis=0)
        ...
        # Normalizacja obrazu
        #print(frame_diff_median)

        # normalized_image = cv2.normalize(frame_diff_median, None, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_8UC1)
        # frame_diff_median = normalized_image
        ...
        threshold =  180
        frame_diff_median[frame_diff_median < 64] = 0
